...
export default function Skills() {
  ...
  const design = [SiBlender, SiFigma, SiCanva];
      ...
      <div className={css.skillsContainer}>
            <div className={css.parentBox}>
              {icons.map((gen, index) => {
                ...
                return (
                  <div className={css.round} key={index}>
                    <Icons />
                  </div>
                );
              })}
          ...
          <div className={css.skillsContainer}>
            ...
            <div className={css.parentBox}>
              {design.map((designing, idx) => {
                ...
                return (
                  <div className={css.round} key={idx}>
                    <Design />
                  </div>
                );
              })}
              ...
              <div className={css.round}>
                <Image width={100} height={100} src={Model.src} alt="Model" />
              </div>
              <div className={css.round}>
                <Image width={100} height={100} src={Spline.src} alt="Model" />
              </div>
            </div>
          </div>
          </div>
